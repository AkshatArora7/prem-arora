...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Personalised real estate guidance from Greater Noida's most experienced advisor. 500+ families served, RERA verified, end-to-end support.",
    images: [{ url: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=1200", width: 1200, height: 630, alt: "Prem Arora — Greater Noida Property Consultant" }],
  },
