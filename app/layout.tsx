...
export const metadata: Metadata = {
  ...
  title: {
    default: `Prem Arora — Greater Noida Industrial & Land Consultant (25+ Yrs)`,
    template: `%s | Prem Arora · Industrial & Land Consultant, Greater Noida`,
  },
  description: "Prem Arora — Greater Noida's most experienced industrial & land consultant. 25+ years of clean-title transactions in GNIDA, YEIDA, UPSIDA & private freehold. Industrial plots, warehousing land, factory sites, legal due diligence.",
  keywords: [
  ...
  openGraph: {
    ...
    url: site.url,
    locale: "en_IN",
    title: "Prem Arora — Greater Noida Industrial & Land Consultant (25+ Yrs)",
    description: "Clean-title industrial plots, warehousing land, factory sites & legal due diligence across GNIDA, YEIDA, UPSIDA and private freehold. 25+ years of trusted advisory.",
  },
  ...
  "@graph": [
    {
      ...
      description: "25+ years of industrial and land real estate advisory in Greater Noida. Specialist in GNIDA, YEIDA, UPSIDA industrial plots, warehousing land, factory sites, freehold and legal due diligence.",
