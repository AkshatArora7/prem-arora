...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "2 BHK Greater Noida", "3 BHK Greater Noida West", "Noida Extension flats",
    "Greater Noida West property", "luxury apartments Greater Noida",
    "ready to move flats Greater Noida", "property near Jewar Airport",
    "Noida International Airport property", "Yamuna Expressway property",
    "YEIDA plots", "YEIDA Sector 18", "YEIDA Sector 20",
    "Jewar Airport real estate", "NRI property consultant Greater Noida",
    "NRI real estate India", "best sector to buy in Greater Noida",
    "Sector Chi Greater Noida", "Sector Pi", "Sector Alpha Greater Noida",
    "Pari Chowk property", "Knowledge Park Greater Noida",
    "Greater Noida property price 2026", "real estate investment Greater Noida",
    "home loan Greater Noida", "sell property Greater Noida",
    "property valuation Greater Noida", "Greater Noida market trends",
  ],
